...
parser.add_argument('--input_image',  type=str, default="test.jpg", help='Path to image with person.')
parser.add_argument('--input_cloth', type=str, default='test_color/003386_1.jpg', help='Path to target cloth image')
